...
const Index = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-gradient-to-br from-[#1a1a1a] to-[#000000] text-center text-stone-300 relative overflow-hidden">
      ...
      <div className="mb-8 z-10 px-4">
        <h1 className="text-6xl md:text-8xl font-bold tracking-wider flex items-baseline justify-center text-amber-400 [text-shadow:0_0_8px_rgba(251,191,36,0.5),0_0_20px_rgba(251,191,36,0.3)]">
