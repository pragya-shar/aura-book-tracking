...
const Auth = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#1a1a1a] to-[#000000] text-stone-300 relative overflow-hidden p-4">
      {/* Film grain effect */}
        ...
        <Tabs defaultValue="login">
          ...
          <TabsContent value="login">
            <Card className="bg-black/30 border-x border-b border-amber-500/30 text-stone-300 rounded-t-none">
              <CardHeader>
                <CardTitle className="text-amber-400 font-pixel tracking-wider">Login</CardTitle>
                <CardDescription className="text-stone-400 font-playfair italic">Enter your credentials to access your account.</CardDescription>
              </CardHeader>
              <CardContent>
                <LoginForm />
              </CardContent>
          ...
          <TabsContent value="signup">
            <Card className="bg-black/30 border-x border-b border-amber-500/30 text-stone-300 rounded-t-none">
              <CardHeader>
                <CardTitle className="text-amber-400 font-pixel tracking-wider">Sign Up</CardTitle>
                <CardDescription className="text-stone-400 font-playfair italic">Create a new account to start tracking your reading.</CardDescription>
              </CardHeader>
              <CardContent>
                <SignUpForm />
              </CardContent>
